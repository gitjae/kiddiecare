...
public class HospitalInfoController {
    ...
    private Map getHospDetailByYadmNm(HospBasisBody hospListData){
        ...
        for(HospBasisItem item : hospListData.getItems()){
            ...
            System.out.println(hospInfoUrl);
            HospDetailItem hospInfoData = openApiDataUtil.getHospData(hospInfoUrl, item);
            System.out.println(hospInfoData);
            ...
            if(hospInfoData!=null){
                dataSet.put("noTrmtHoli",hospInfoData.getNoTrmtHoli());
    ...
    public Map getHospDetail(@RequestParam(defaultValue="") String ykiho){
        ...
        String url = baseUrl + admDtlInfoService + getDgsbjtInfo + encodeServiceKey + "&ykiho=" + ykiho;
